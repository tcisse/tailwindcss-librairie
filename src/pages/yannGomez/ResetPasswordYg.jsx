...
import passwordLogo from "../../assets/img/passord.jpg";
const style = {
        ...
        <div className={style.wrapper}>
            ...
            <div className={style.container}>
                <form className={style.form}>
                    <h2 className={style.titleH2}>Forgot Password</h2>
                    <h4 className={style.titleH4}>Enter your email address</h4>
                    ...
                    <div className={style.buttonContainer}>
                        <Link to="/signin-yag" className={style.buttonBack}>
                            <button>Back</button>
                        </Link>
                        <Link to="/update-password-yag" className={style.buttonReset}>
