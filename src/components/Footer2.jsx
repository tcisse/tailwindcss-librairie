    ...
    <div className="flex flex-col justify-center items-center bg-gray-800 text-white px-8 lg:px-24 py-24">
        <div className="flex justify-between items-start flex-wrap flex-row w-full text-left">
            ...
            <div className="flex justify-start flex-col w-[250px] lg:m-4 mx-0 my-4">
                ...
                <p className=" text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">Home</p>
                <p className=" text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">Products</p>
                <p className=" text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">About</p>
                <p className=" text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">Features</p>
                <p className=" text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">Contact</p>
            </div>
            <div className="flex justify-start flex-col w-[250px] lg:m-4 mx-0 my-4">
                <h4 className="font-medium leading-[16px] text-[#FFFFFF] mb-6 whitespace-nowrap">Resources Links</h4>
                <p className="text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer whitespace-nowrap mb-4">Download Whitepapper</p>
                <p className="text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">Smart Token</p>
                <p className="text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">Blockchain Explore</p>
                <p className="text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">Crypto API</p>
                <p className="text-[12px] leading-[14px] hover:text-orange-500 transition cursor-pointer mb-4">Interest</p>
            </div>
            <div className="flex justify-start flex-col w-[250px] lg:m-4 mx-0 my-4">
                <h3 className="font-medium text-center mb-5 lg:mb-10 lg:text-left whitespace-nowrap">We accept following payment systems</h3>
