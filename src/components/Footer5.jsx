      ...
      <div>
        <div className="flex justify-between items-start flex-wrap flex-row w-full text-left">
          ...
          <div className="flex justify-start flex-col w-[250px] lg:m-4 mx-0 my-4">
            <h4 className="text-2xl leading-[16px] font-extrabold mb-6">Links</h4>
          ...
          <div className="flex justify-start flex-col w-[250px] lg:m-4 mx-0 my-4">
            ...
            <p className="text-xs leading-lg mb-4">085-132567</p>
            <p className="text-xs leading-lg mb-4">info@payme.net</p>
          </div>
        </div>
      </div>
    </div>
